...
Source0  : https://github.com/Ultimaker/fdm_materials/archive/4.11.0/fdm_materials-4.11.0.tar.gz
...
%prep
%setup -q -n fdm_materials-4.11.0
cd %{_builddir}/fdm_materials-4.11.0
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1631719848
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/fdm_materials-4.11.0/LICENSE %{buildroot}/usr/share/package-licenses/fdm_materials/5f66eb3703482d8c327484f5b29041e8104d1e38
pushd clr-build
%make_install
popd
