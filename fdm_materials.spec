...
Source0  : https://github.com/Ultimaker/fdm_materials/archive/4.1.0/fdm_materials-4.1.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1563993790
mkdir -p clr-build
pushd clr-build
...
cp LICENSE %{buildroot}/usr/share/package-licenses/fdm_materials/LICENSE
pushd clr-build
%make_install
popd
...
/usr/share/cura/resources/materials/imade3d_petg_green.xml.fdm_material
/usr/share/cura/resources/materials/imade3d_petg_pink.xml.fdm_material
/usr/share/cura/resources/materials/imade3d_pla_green.xml.fdm_material
/usr/share/cura/resources/materials/imade3d_pla_pink.xml.fdm_material
...
/usr/share/package-licenses/fdm_materials/LICENSE
