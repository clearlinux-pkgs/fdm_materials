...
Source0  : https://github.com/Ultimaker/fdm_materials/archive/4.2.0/fdm_materials-4.2.0.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1565053847
mkdir -p clr-build
pushd clr-build
