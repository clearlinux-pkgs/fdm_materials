...
Source0  : https://github.com/Ultimaker/fdm_materials/archive/4.9.1/fdm_materials-4.9.1.tar.gz
...
%prep
%setup -q -n fdm_materials-4.9.1
cd %{_builddir}/fdm_materials-4.9.1
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1620749922
mkdir -p clr-build
pushd clr-build
...
cp %{_builddir}/fdm_materials-4.9.1/LICENSE %{buildroot}/usr/share/package-licenses/fdm_materials/5f66eb3703482d8c327484f5b29041e8104d1e38
pushd clr-build
%make_install
popd
