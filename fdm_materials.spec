...
Version  : 3.6.0
Release  : 1
URL      : https://github.com/Ultimaker/fdm_materials/archive/3.6.0.tar.gz
Source0  : https://github.com/Ultimaker/fdm_materials/archive/3.6.0.tar.gz
...
export LANG=C
export SOURCE_DATE_EPOCH=1548367264
mkdir -p clr-build
pushd clr-build
%cmake ..
